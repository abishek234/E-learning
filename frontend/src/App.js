...
import EditUser from './Components/EditStudents';
import EditInstructor from './Components/EditInstructors';
...
import AddTutors from './Components/DashBoard/AddTutors';
import InstructorDashboard from './Components/InstructorDashBoard/Dashboard';
import InstructorCourses from './Components/InstructorDashBoard/DCourses';
import AdminMail from './Components/InstructorDashBoard/AdminMail';
import QuestionsTable from './Components/InstructorDashBoard/QuestionTable';
import MaterialsTable from './Components/InstructorDashBoard/MaterialTable';
import StudentPerformance from './Components/InstructorDashBoard/Performance';
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/editInstructor/:id' Component={EditInstructor}></Route>
          <Route path='/editQuestion/:id' Component={EditQuestion}></Route>
          ...
          <Route path='/AddTutors' Component={AddTutors}></Route>
          <Route path='/AdminMail' Component={AdminMail}></Route>
          <Route path='/QuestionsTable' Component={QuestionsTable}></Route>
          <Route path='/MaterialsTable' Component={MaterialsTable}></Route>
          <Route path='/Performance' Component={Performance} />
          <Route path='/StudentPerformance' Component={StudentPerformance} />
          <Route path='/PerformanceAnalysis' Component={PerformanceAnalysis} />
